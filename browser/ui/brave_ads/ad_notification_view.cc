...
constexpr SkColor kDarkModeBorderColor = SkColorSetRGB(0x1d, 0x20, 0x24);
...
void AdNotificationView::UpdateView() {
  ...
  SetBackground(views::CreateBackgroundFromPainter(
      std::make_unique<AdNotificationBackgroundPainter>(
          ...
          should_use_dark_colors ? kDarkModeBackgroundColor
                                 : kLightModeBackgroundColor)));

  SetBorder(views::CreateRoundedRectBorder(
      kBorderThickness, kCornerRadius,
      should_use_dark_colors ? kDarkModeBorderColor : kLightModeBorderColor));
