...
class BraveBrowserProcessImpl : public BraveBrowserProcess,
 ...
 public:
  ...
  brave_shields::AdBlockCustomFiltersService* ad_block_custom_filters_service() override;
...
#endif
  brave_shields::TrackingProtectionService* tracking_protection_service() override;
  ...
  speedreader::SpeedreaderRewriterService* speedreader_rewriter_service() override;
#endif
